...
public class HoaDonDAO implements InterfaceHoadon {
    ...
    public void insert(Hoadon Entity) {
        com.mycompany.Helper.ConnectUtil.update(INSERT_SQL, Entity.getIdNhanVien(), Entity.getNgayTao(), Entity.isTrangThai(),
    ...
    public void updateThanhToan(Hoadon Entity) {
        com.mycompany.Helper.ConnectUtil.update(UPDATE_SQL_TrangThaiTT, Entity.isTrangThaiTT(), Entity.getIdHoaDon());
    }

    @Override
    public void delete(Hoadon Entity) {
        com.mycompany.Helper.ConnectUtil.update(DELETE_SQL, Entity.getIdHoaDon());
    }

    public void updatekh(Hoadon Entity) {
        com.mycompany.Helper.ConnectUtil.update(UPDATE_SQL_khachhang, Entity.getSDT(), Entity.getTen(), Entity.getTienShip(), Entity.getDiaChi(), Entity.getIdHoaDon());
    }
    ...
    public void updateTrangThai(Hoadon Entity) {
        com.mycompany.Helper.ConnectUtil.update(UPDATE_SQL_TrangThai, Entity.isTrangThai(), Entity.getIdHoaDon());
    }

    @Override
    public void updateThanhtien(Hoadon Entity) {
        com.mycompany.Helper.ConnectUtil.update(UPDATE_SQL_ThanhTien, Entity.getThanhTien(), Entity.getIdHoaDon());
    }

    @Override
    public void updateLydohuy(Hoadon Entity) {
        com.mycompany.Helper.ConnectUtil.update(UPDATE_SQL_Ly_DO, Entity.getLyDoHuy(), Entity.getIdHoaDon());
    }

    @Override
    public void updateSLSPHUY(Hoadon Entity) {
        com.mycompany.Helper.ConnectUtil.update(UPDATE_SQL_DEM_SP_HUY, Entity.getSlSanPhamHuy(), Entity.getIdHoaDon());
    }
