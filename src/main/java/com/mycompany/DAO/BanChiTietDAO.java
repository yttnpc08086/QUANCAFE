...
import com.mycompany.Model.BanChiTiet;
...
public class BanChiTietDAO implements InterfaceBanchitiet{
    ...
    public void insert(BanChiTiet Entity) {
        com.mycompany.Helper.ConnectUtil.update(INSERT_SQL, Entity.getID_Ban(), Entity.getID_HoaDon(), Entity.getThoidiemCoNguoi(), Entity.isBanChinh());
    }

    @Override
    public void update(int idban,int idHoadon) {
        com.mycompany.Helper.ConnectUtil.update(UPDATE_SQL, idban,idHoadon);
    }

    @Override
    public void delete(int id) {
        com.mycompany.Helper.ConnectUtil.update(DELETE_SQL, id);
    }
    ...
    public List<Integer> selectallbangop(){
        ...
        try {
            ResultSet rs = ConnectUtil.query(SELECT_ALL_BAN_GOP);
            while (rs.next()) {
