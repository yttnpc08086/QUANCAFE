...
//        "AND dbo.HoaDon.TTThanhtoan = 0 AND Donchinh = 1 AND dbo.HoaDon.ID_Hoadon = ?";
    public void insert(Ban Entity) {
        com.mycompany.Helper.ConnectUtil.update(INSERT_SQL, Entity.getIdBan(), Entity.isTrangThai(),Entity.isHoatDong(),Entity.getSoluongcho());
    }

    public void updateTrangThai(int id) {
        com.mycompany.Helper.ConnectUtil.update(UPDATE_SQL_TRANGTHAI, id);
    }

    public void deleteTRangThai(int id) {
        com.mycompany.Helper.ConnectUtil.update(DELETE_SQL_TRANGTHAI, id);
    }
...
//    }
    ...
    public void updateHoatDong(int id) {
        com.mycompany.Helper.ConnectUtil.update(UPDATE_SQL_HD, id);
    }

    public void deleteHoatDong(int id) {
        com.mycompany.Helper.ConnectUtil.update(DELETE_SQL_HD, id);
    }
    ...
    public void delete(int id) {
        com.mycompany.Helper.ConnectUtil.update(DELETE, id);
    }
    ...
    public void update(Ban Entity) {
        com.mycompany.Helper.ConnectUtil.update(UPDATE_SQL, Entity.getSoluongcho(), Entity.isTrangThai(), Entity.isHoatDong(), Entity.getIdBan());
    }
